...
export class EmployeeEdit extends Component {
    ...
    constructor(props) {
        super(props);
        this.state = { id: 0, fullName: '', birthdate: '', birthDateShort: '', salary: 0, tin: '', typeId: 1, loading: true, loadingSave: false };
    }
                ...
                <form>
                    <div className='form-row'>
                        ...
                        <div className='form-group col-md-6'>
                            ...
                            <input type='date' className='form-control' id='inputBirthdate4' onChange={this.handleChange.bind(this)} name="birthDateShort" value={this.state.birthDateShort} placeholder='Birthdate' />
                        </div>
                    </div>
                    <div className="form-row">
                        <div className='form-group col-md-6'>
    ...
    async saveEmployee() {
        this.setState({ loadingSave: true, birthdate: this.state.birthDateShort });
    ...
    async getEmployee(id) {
        ...
        this.setState({ id: data.id, fullName: data.fullName, birthdate: data.birthdate, birthDateShort: data.birthDateShort, salary: data.salary, tin: data.tin, typeId: data.typeId, loading: false, loadingSave: false });
    }
}
